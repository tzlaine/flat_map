...
node handles (26.2.4) and iterator
invalidation (26.6.1).  A \tcode{flat_map}
...
instantiate \tcode{flat_map}. In particular, \tcode{vector} (26.3.11) and
...
requirements as described in (26.2.1).
...
container (26.2.6), except for the requirements related to
node handles (26.2.4) and iterator
invalidation (26.6.1).  A \tcode{flat_multimap}
does not meet the additional requirements of an allocator-aware container, as
described in
Table 80.
...
\pnum
Any sequence container supporting random access iteration can be used to
instantiate \tcode{flat_multimap}. In particular, \tcode{vector} (26.3.11)
