  ...
  public:
    ...
    template <ranges::input_range R>
      explicit flat_set(const R& range,
        ...
        : flat_set(ranges::begin(range), ranges::end(range), comp) { }
    template <ranges::input_range R, class Allocator>
      flat_set(const R& range, const Allocator& a);
    ...
    template <ranges::input_range R>
      flat_set(sorted_unique_t s,
               const R& range,
               const key_compare& comp = key_compare())
        : flat_set(s, ranges::begin(range), ranges::end(range), comp) { }
    template <ranges::input_range R, class Allocator>
      flat_set(sorted_unique_t, const R& range, const Allocator& a);
    ...
    template<@\placeholder{container-compatible-range}@<value_type> R>
      flat_set(from_range_t fr, const R& range)
...
class flat_multiset {
  public:
    ...
    template <ranges::input_range R>
      explicit flat_multiset(const R& range,
                             const key_compare& comp = key_compare())
        : flat_multiset(ranges::begin(range), ranges::end(range), comp) { }
    template <ranges::input_range R, class Allocator>
      flat_multiset(const R& range, const Allocator& a);
    ...
    template <ranges::input_range R>
      flat_multiset(sorted_equivalent_t s,
                    const R& range,
                    const key_compare& comp = key_compare())
        : flat_multiset(s, ranges::begin(range), ranges::end(range), comp) { }
    template <ranges::input_range R, class Allocator>
      flat_multiset(sorted_equivalent_t, const R& range, const Allocator& a);
    ...
    template<@\placeholder{container-compatible-range}@<value_type> R>
      flat_multiset(from_range_t fr, const R& range)
