...
based on the keys. \tcode{flat_map} supports input iterators that meet the
\oldconcept{InputIterator} requirements and model model the \libconcept{random_access_iterator}
...
\pnum
The behavior of \tcode{flat_map} is undefined if either
of \tcode{KeyContainer::swap()} or \tcode{MappedContainer::swap()} throws.
...
namespace std {
  ...
  public:
    ...
    template <ranges::range Range>
      explicit flat_map(const Range& range,
                        const key_compare& comp = key_compare())
        : flat_map(ranges::begin(cont), ranges::end(cont), comp) { }
    template <ranges::range Range, class Allocator>
      flat_map(const Range& range, const Allocator& a);
    ...
    template <ranges::range Range>
      flat_map(sorted_unique_t s,
               const Range& range,
               const key_compare& comp = key_compare())
        : flat_map(s, ranges::begin(cont), ranges::end(cont), comp) { }
    template <ranges::range Range, class Allocator>
      flat_map(sorted_unique_t, const Range& range, const Allocator& a);
  ...
  template <class Range>
    flat_map(Range)
      -> flat_map<@\placeholder{cont-key-type}@<Range>, @\placeholder{cont-mapped-type}@<Range>>;
  ...
  template <class Range>
    flat_map(sorted_unique_t, Range)
      -> flat_map<@\placeholder{cont-key-type}@<Range>, @\placeholder{cont-mapped-type}@<Range>>;
...
supports input iterators that meet the \oldconcept{InputIterator} requirements
and model model the \libconcept{random_access_iterator} concept
...
\pnum
The behavior of \tcode{flat_multimap} is undefined if either
of \tcode{KeyContainer::swap()} or \tcode{MappedContainer::swap()} throws.
...
namespace std {
  ...
  public:
    ...
    flat_multimap(const key_container_type& key_cont,
                  ...
                  const Allocator& a);
    template <ranges::range Range>
      explicit flat_multimap(const Range& range,
                             const key_compare& comp = key_compare())
        : flat_multimap(ranges::begin(cont), ranges::end(cont), comp) { }
    template <ranges::range Range, class Allocator>
      flat_multimap(const Range& range, const Allocator& a);
    ...
    template <ranges::range Range>
      flat_multimap(sorted_equivalent_t s,
                    const Range& range,
                    const key_compare& comp = key_compare())
        : flat_multimap(s, ranges::begin(cont), ranges::end(cont), comp) { }
    template <ranges::range Range, class Allocator>
      flat_multimap(sorted_equivalent_t, const Range& range, const Allocator& a);
  ...
  template <class Range>
    flat_multimap(Range)
      -> flat_multimap<@\placeholder{cont-key-type}@<Range>, @\placeholder{cont-mapped-type}@<Range>>;
  ...
  template <class Range>
    flat_multimap(sorted_equivalent_t, Range)
      -> flat_multimap<@\placeholder{cont-key-type}@<Range>, @\placeholder{cont-mapped-type}@<Range>>;
