...
\pnum
\effects
First, initializes an object \tcode{t} of type \tcode{pair<key_type, mapped_type>}
...
\begin{itemdescr}
\pnum
\constraints The \grammarterm{qualified-id} \tcode{Compare::is_transparent} is valid
